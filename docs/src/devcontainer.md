...
| `apache-airflow-providers-snowflake` | 6.9.1 |
...
| `mypy-boto3-glue` | 1.42.43 |
| `mypy-boto3-lakeformation` | 1.42.45 |
...
| `openlineage-python` | 1.44.1 |
| `openlineage-sql` | 1.44.1 |
| `openpyxl` | 3.1.5 |
